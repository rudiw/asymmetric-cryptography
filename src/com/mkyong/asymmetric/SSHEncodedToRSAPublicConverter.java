...
/**
 * https://stackoverflow.com/questions/47816938/java-ssh-rsa-string-to-public-key?noredirect=1&lq=1
 * 
 * @author Rudi_W144
 *
 */
public class SSHEncodedToRSAPublicConverter {
	...
	public RSAPublicKeySpec convertToRSAPublicKey() {
		try {
			...
			checkArgument(size(parts) >= 2 && SSH_MARKER.equals(get(parts, 0)),
					"bad format, should be: ssh-rsa AAAB3....");
